  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 max-w-md space-y-3 pointer-events-none">
      ...
      <motion.button
        ...
        className="fixed top-6 right-6 p-3 rounded-full bg-dark-card border border-dark-border hover:border-accent-blue/50 transition-all pointer-events-auto z-50"
